...
%   output the input interaction mxktrix R_out, where the empty rows of the
...
%    
    ...
    [sortedVals, sortedIdx] = sort(all_sims(cero_rows,:), 2, "descend");
    max_sim_Val = sortedVals(:, 1:k);
    max_sim_Idx = sortedIdx(:, 1:k);
